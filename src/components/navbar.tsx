...
export const Navbar = () => {
	...
	return (
		<NavigationMenu className="sticky top-0 flex  min-w-full flex-col items-stretch  overflow-hidden whitespace-nowrap text-xl font-bold uppercase text-gold md:h-20 md:flex-row md:items-center md:justify-between md:bg-black xl:px-12 2xl:px-24 min-[1780px]:px-72">

...
export const AboutMe = () => {
	return (
		<section className="bg-white">
			<Heading lineColor="border-black" text="O mnie" textColor="text-black" />
			<div className="mx-auto flex max-w-screen-xl flex-col gap-8 px-8 lg:flex-row">
				<div className="mb-8 flex flex-col gap-y-8 leading-8 md:mt-12 lg:w-1/2  lg:text-base">
					...
					<p>
						...
						chodzi o to by być wiecznie młodym, lecz by zestarzeć się później i
						piękniej.
					</p>
					<p>
						Nieustannie doskonalę swoje umiejętności uczestnicząc w
						specjalistycznych szkoleniach pod okiem ekspertów kosmetologii i
						medycyny estetycznej, a także licznych konferencjach branżowych, co
						pozwala mi być na bieżąco z najnowszymi trendami.
					</p>
					<p>
						...
						poszczególne zabiegi. Używam wyłącznie produktów innowacyjnych marek
						profesjonalnych o potwierdzonych efektach działania. Swoją ofertę
						zbudowałam m.in. w oparciu o asortyment firmy Rhonda Allison,
						Revitacare czy Mesoestetic. Kieruję się potrzebami klientów – nowe
						innowacje w mojej ofercie często inspirowane są potrzebami
